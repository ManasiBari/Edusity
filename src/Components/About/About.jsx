  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>
                Embark, on a transormative educational journey with our 
                university's comprehensive education programs. Our cutting-edge 
                curriculum is desgened to empower students with the knnowledhe, 
                skills, and experiences needed to excel in the dynamic field of education...
            </p>
            <p>
                With a focus on innovationm hands-on learningk and personalized 
                mentorship, our programs prepare aspirinng educators to make a 
